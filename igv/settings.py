"""
Django settings for igv project.
...
SECRET_KEY = "django-insecure-g1rhjy&ws^_-!815l*g1(qywdxp$f3uts#j^98%n1mq+q9ak3)"
...
WSGI_APPLICATION = "igv.wsgi.application"
...
STATICFILES_DIRS =[
    os.path.join(BASE_DIR, "apps/bamView/static"),
]
